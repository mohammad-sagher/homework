...
return $this->returnData("tag",new TagResource($tag),"this is tags",200);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return $this->returnData(new TagResource($tag),"Tag updated successfuly",200);
